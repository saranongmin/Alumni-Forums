...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-md-6">Blog List</div>
                <div class="col-md-6 text-right">

                    <a href="{{ route('blogs.create') }}" class="btn btn-sm btn-outline-primary">Add Blog</a>
                     <a href="{{ route('blogs.pdf') }}" class="btn btn-sm btn-outline-danger">Download Pdf</a>
                </div>
            </div>
        </div>
        <div class="card-body">
