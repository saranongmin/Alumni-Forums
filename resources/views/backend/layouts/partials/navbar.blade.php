<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
 ...
 <!-- Nav Item - Alerts -->
        @can('users.viewAny')
        <li>
           <a href="{{route('users.index')}}"><button class="mt-3 btn btn-sm btn-outline-warning"> All Users </button></a>
        </li>
        @endcan
        <!-- Nav Item - Alerts -->
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                @isset(auth()->user()->userprofile->picture)
                @if(file_exists(storage_path().'/app/public/users/'.auth()->user()->userprofile->picture) && (!is_null(auth()->user()->userprofile->picture)))
                    <img class="img-profile rounded-circle" src="{{ asset('storage/users/'.auth()->user()->userprofile->picture) }}" height="100">
                @else
